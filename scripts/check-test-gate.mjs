 ...
 * carries 160 at the time of writing; the floor exists to catch a vacuous run,
 ...
 * @returns the executed count, the failed count, and the child's exit code.
 */
...
const { executed, failed, exitCode } = await runSuite();

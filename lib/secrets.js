...
export const SECRET_MANAGERS = [SECRET_MANAGER_AUTO, SECRET_MANAGER_NONE, SECRET_MANAGER_GNOME, SECRET_MANAGER_PASS];
 ...
 * @returns the value with its source, or a note explaining what was tried.
 */
export async function lookupGnomeKeyring(attributes, options = {}) {
  ...
  try {
    ...
    return { value, source: SECRET_MANAGER_GNOME };
  } catch (error) {
...
export async function lookupPass(path, options = {}) {
  ...
  try {
    ...
    return { value, source: SECRET_MANAGER_PASS };
  } catch (error) {
